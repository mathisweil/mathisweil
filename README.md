...
*2025 to 2026*
Modules: Applied Machine Learning, Introduction to Statistical Data Science, Statistical NLP, Information Retrieval & Data Mining, Bayesian Deep Learning, Open-Endedness & General Intelligence, Digital Finance.

**MSc Project (Summer 2026):** Federated Machine Learning for Insurance, in industry collaboration with Ki Insurance.
